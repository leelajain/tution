...
<?php echo form_open('Student_cont/addStudent'); ?>
<br>
    <div class="content">   
                    ...
                    <div class="card">
                            ...
                            <div class=" setup-content " id="step-1">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>DOB</label>
                                            <input type="date" name="dob" class="form-control border-input" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Address</label>
                                            <textarea rows=2 class="form-control border-input" placeholder="Home Address" value="Melbourne, Australia" name = "address"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="text-center">
                                        <button type="submit"  id="activate-step-3" class="btn btn-info btn-fill btn-wd"> Next</button>
                                    </div>
                                    <div class="clearfix"></div>    
                                </div>
                            </div>
                        ...
                        <div class=" setup-content" id="step-3">           
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control border-input"  placeholder="Total Fees "     name="total_fees" id='Resources'>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control border-input"  placeholder="Total Fees " name="discount" id='Minutes' onblur='Calculate();' >
                                    </div> 
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Final Amount</label>
                                        <input type="text" class="form-control border-input"  placeholder="Final Amount " name="final" id='answer' readonly  >
                                    </div>
                                </div>
                            </div> 
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control border-input"  placeholder="Total Fees "     name="received">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Balance</label>
                                        <div>
                                            <input type="text" class="form-control border-input"  placeholder="Total Fees "     name="balance" >
                                        </div>
                                    </div>
                                </div>            
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label>Place</label>
                                        <input type="text" class="form-control border-input"  placeholder="Place " name="place">
                                    </div>
                                </div>
